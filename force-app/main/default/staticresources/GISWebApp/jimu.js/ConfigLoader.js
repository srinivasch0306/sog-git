  ...
  clazz = declare(null, {
    ...
    ********************************************************/
    ...
    _processSignIn: function(portalUrl, isWebTier){
      ...
      var defSignIn;
	  //BG - This is to check if there is a ArcGIS Server that is being used instead of ArcGIS Online
	  var isOnPremGISServer = this.appConfig.tokenInfo && this.appConfig.tokenInfo.tokenServicesUrl && this.appConfig.tokenInfo.tokenServicesUrl != '';
	  window.appInfo.isRunInPortal = isOnPremGISServer;
      if(window.appInfo.isRunInPortal){
