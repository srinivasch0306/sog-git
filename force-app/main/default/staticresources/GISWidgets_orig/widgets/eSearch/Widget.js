  ...
  function (
    ...
    bgFields: null,
      ...
      postCreate: function () {
        ...
        //comment below 3 dojo subscribes to remove assignto functionality
      ...
      //comment below 2 methods to remove assignto functionality
...
//modify the currentFeatures with the new results
      ...
      _addLinksGISResults: function(layerIndex, results, features) {
        ...
        var fieldVals = [];
          ...
          var bgFieldName, bgFieldValue, attrName;
                ...
                if(bgResult!=null && bgResult.length>0){        
                    if(bgResult[0].obj[bgFieldName] != null && feature.attributes[GISFieldName] == bgResult[0].obj[bgFieldName]){        
                        ...
                        for( var key in bgResult[0].actionLinks) {        
                            feature.infoTemplate.info.description += "<a href=\"" + bgResult[0].actionLinks[key]+"\" target=\"_blank\">" + key+ "</a> <br/><br/>";        
                        }        
                    }         
                }
            }
      ...
      _drawBGResults: function(results) {
        ...
        for (var i = 1; i < len; i++) {
          ...
          // Not using Assign To User function now. comment from here to //show nearby to remove assign to functionality
